...
typedef struct __mavlink_piksi_obs_t {
 ...
 uint8_t data[249]; /*<  observation data*/
} mavlink_piksi_obs_t;

#define MAVLINK_MSG_ID_PIKSI_OBS_LEN 254
#define MAVLINK_MSG_ID_PIKSI_OBS_MIN_LEN 254
#define MAVLINK_MSG_ID_181_LEN 254
#define MAVLINK_MSG_ID_181_MIN_LEN 254

#define MAVLINK_MSG_ID_PIKSI_OBS_CRC 110
#define MAVLINK_MSG_ID_181_CRC 110

#define MAVLINK_MSG_PIKSI_OBS_FIELD_DATA_LEN 249
...
#define MAVLINK_MESSAGE_INFO_PIKSI_OBS { \
    ...
    {  { "sender_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_piksi_obs_t, sender_id) }, \
         ...
         { "data", NULL, MAVLINK_TYPE_UINT8_T, 249, 5, offsetof(mavlink_piksi_obs_t, data) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PIKSI_OBS { \
                               ...
                               uint16_t sender_id, uint16_t msg_type, uint8_t len, const uint8_t *data)
{
    ...
    _mav_put_uint8_t_array(buf, 5, data, 249);
...
{
    return _MAV_RETURN_uint8_t_array(msg, data, 249,  5);
}

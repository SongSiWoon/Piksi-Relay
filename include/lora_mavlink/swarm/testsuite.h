...
static void mavlink_test_piksi_obs(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_piksi_obs_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_obs_pack(system_id, component_id, &msg , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_obs_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_obs_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_obs_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_piksi_obs_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_obs_send(MAVLINK_COMM_1 , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_obs_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_piksi_base_pos_ecef(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_piksi_base_pos_ecef_t packet_in = {
        17235,17339,17,{ 84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107 }
    };
    ...
    mavlink_msg_piksi_base_pos_ecef_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_base_pos_ecef_pack(system_id, component_id, &msg , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_base_pos_ecef_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_base_pos_ecef_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_base_pos_ecef_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_piksi_base_pos_ecef_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_base_pos_ecef_send(MAVLINK_COMM_1 , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_base_pos_ecef_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_piksi_glo_biases(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_piksi_glo_biases_t packet_in = {
        17235,17339,17,{ 84, 85, 86, 87, 88, 89, 90, 91, 92 }
    };
    ...
    mavlink_msg_piksi_glo_biases_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_glo_biases_pack(system_id, component_id, &msg , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_glo_biases_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_glo_biases_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_glo_biases_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_piksi_glo_biases_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_piksi_glo_biases_send(MAVLINK_COMM_1 , packet1.sender_id , packet1.msg_type , packet1.len , packet1.data );
    mavlink_msg_piksi_glo_biases_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
